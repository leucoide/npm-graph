  ...
  render: function() {
    return (
      React.createElement("div", null, 
        React.createElement(JobSubmit, {url: "/crawl"}), 
        React.createElement(JobList, {jobs: this.state.jobs})
      )
    );
  }
});

var JobSubmit = React.createClass({displayName: 'JobSubmit',
  getInitialState: function() {
    return {data:{}};
  },
  render: function(){
    return(
      React.createElement("div", null, 
        React.createElement("form", {onSubmit: this.handleSubmit}, 
          React.createElement("input", {type: "text", ref: "from"}), 
          React.createElement("input", {type: "text", ref: "to"}), 
...
var JobList = React.createClass({displayName: 'JobList',
  renderJob:function(jobId){
    ...
    return(
      React.createElement(JobDisplay, {key: jobId, jobId: jobId, jobInfo: jobInfo})
    )
  },
  render:function(){
...
var JobDisplay = React.createClass({displayName: 'JobDisplay',
  ...
  render:function(){
    ...
    return(
      React.createElement("div", null, 
      React.createElement("div", null, "JOB ", this.props.jobId, " ::from ", this.props.jobInfo.startPoint, " to ", this.props.jobInfo.endPoint, ":: "), 
      React.createElement("div", null, this.props.jobInfo.current, " of ", this.props.jobInfo.total), 
      React.createElement("div", null, timeToFinish, " seconds remeaning"), 
      React.createElement("div", null, "---------------------------------------------")
...
},{"react":147,"zepto-browserify":148}],2:[function(require,module,exports){
/**
